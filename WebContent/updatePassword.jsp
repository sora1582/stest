...
<script type="text/javascript">
	function submitForm(){
		var userId='${sessionScope.users.username }';
		var password='${sessionScope.users.password}';
	...
	<div style="margin-top:10px;">
		<table align="center" style="border-collapse:separate; border-spacing:5px 15px;">
			<tr>
				...
				<td>
					<input type="text" id="userName" value="${sessionScope.users.username }" readonly="readonly">
				</td>
			</tr>
			<tr>
